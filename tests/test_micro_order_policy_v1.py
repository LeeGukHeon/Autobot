...
def test_micro_order_policy_assigns_tiers_from_liquidity_score() -> None:
    ...
    low = policy.evaluate(micro_snapshot=_snapshot(trade_events=1, trade_notional_krw=100.0))
    high = policy.evaluate(micro_snapshot=_snapshot(trade_events=500, trade_notional_krw=5_000_000_000.0))
