...
def _make_fake_systemctl(tmp_path: Path) -> Path:
    if os.name == "nt":
        ...
        wrapper_path.write_text(
            ...
            "echo autobot-paper-v4-challenger.service enabled enabled\r\n"
            "echo autobot-live-alpha.service enabled enabled\r\n"
            "echo autobot-live-alpha-candidate.service enabled enabled\r\n"
            "echo autobot-v4-challenger-spawn.service enabled enabled\r\n"
            "echo autobot-v4-challenger-promote.service enabled enabled\r\n"
            "exit /b 0\r\n"
            ":is_active\r\n"
            "set \"TARGET=%2\"\r\n"
