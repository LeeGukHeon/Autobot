...
- `strategy.micro_order_policy.cross_tick_bps_max`: number, bps unit (default: `10.0`)
- `strategy.micro_order_policy.cross_escalate_after_timeouts`: integer (default: `2`)
- `strategy.micro_order_policy.cross_min_prob`: number nullable (default: `null`)
- `strategy.micro_order_policy.cross_micro_stale_ms`: integer nullable (default: `null`)
- `strategy.micro_order_policy.abort_if_tick_bps_gt`: number nullable, bps unit (default: `null`)
- `strategy.micro_order_policy.tick_size_resolver`: `upbit_rules | krw_table | auto` (default: `auto`)
...
- `features_v3.one_m_drop_if_real_count_zero`: bool (default: `true`)
- `features_v3.one_m_synth_weight_floor`: float in `[0,1]` (default: `0.2`)
- `features_v3.one_m_synth_weight_power`: float `>= 0` (default: `2.0`)
- `features_v3.sample_weight_half_life_days`: float (default: `60`)
- `features_v3.universe_quality_enabled`: bool (default: `true`)
- `features_v3.universe_quality_lookback_days`: integer (default: `3`)
- `features_v3.universe_quality_beta`: float `>= 0` (default: `2.0`)
- `features_v3.universe_quality_q_floor`: float in `[0,1]` (default: `0.2`)
- `features_v3.universe_quality_oversample_factor`: integer `>= 1` (default: `3`)
