    ...
    return normalize_model_exit_plan_payload(
        {
            ...
            "min_tp_floor_pct": _as_float(_first_field("min_tp_floor_pct")),
            "path_risk": dict(_first_field("path_risk") or {}) if isinstance(_first_field("path_risk"), dict) else {},
            "entry_selection_score": _as_float(_first_field("entry_selection_score")),
            "entry_risk_feature_value": _as_float(_first_field("entry_risk_feature_value")),
            ...
            "expected_exit_fee_rate": _as_float(_first_field("expected_exit_fee_rate")),
            "expected_exit_slippage_bps": _as_float(_first_field("expected_exit_slippage_bps")),
            "expected_immediate_exit_fee_rate": _as_float(_first_field("expected_immediate_exit_fee_rate")),
            "expected_immediate_exit_slippage_bps": _as_float(_first_field("expected_immediate_exit_slippage_bps")),
...
def _build_position_policy_jsons(plan_payload: dict[str, Any]) -> tuple[str, str, str]:
    ...
    shared = {
        ...
        "min_tp_floor_pct": _as_float(normalized_plan.get("min_tp_floor_pct")),
        "path_risk": dict(normalized_plan.get("path_risk") or {}) if isinstance(normalized_plan.get("path_risk"), dict) else {},
        "entry_selection_score": _as_float(normalized_plan.get("entry_selection_score")),
        "entry_risk_feature_value": _as_float(normalized_plan.get("entry_risk_feature_value")),
        "expected_exit_fee_rate": _as_float(normalized_plan.get("expected_exit_fee_rate")),
        "expected_exit_slippage_bps": _as_float(normalized_plan.get("expected_exit_slippage_bps")),
        "expected_immediate_exit_fee_rate": _as_float(normalized_plan.get("expected_immediate_exit_fee_rate")),
        "expected_immediate_exit_slippage_bps": _as_float(normalized_plan.get("expected_immediate_exit_slippage_bps")),
