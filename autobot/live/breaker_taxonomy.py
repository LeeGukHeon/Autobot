...
_REASON_SPECS: dict[str, BreakerReasonSpec] = {
    ...
    "RISK_CONTROL_NONPOSITIVE_RATE_CS_BREACH": BreakerReasonSpec(
        reason_code="RISK_CONTROL_NONPOSITIVE_RATE_CS_BREACH",
        breaker_type=BREAKER_TYPE_STATISTICAL_RISK,
        subtype="confidence_sequence_monitor",
        default_action=ACTION_HALT_NEW_INTENTS,
        clear_policy=CLEAR_POLICY_ONLINE_BASELINE_CLEAR,
        summary="The nonpositive-return confidence-sequence monitor breached its threshold.",
    ),
    "RISK_CONTROL_SEVERE_LOSS_RATE_CS_BREACH": BreakerReasonSpec(
        reason_code="RISK_CONTROL_SEVERE_LOSS_RATE_CS_BREACH",
        breaker_type=BREAKER_TYPE_STATISTICAL_RISK,
        subtype="confidence_sequence_monitor",
        default_action=ACTION_HALT_NEW_INTENTS,
        clear_policy=CLEAR_POLICY_ONLINE_BASELINE_CLEAR,
        summary="The severe-loss-rate confidence-sequence monitor breached its threshold.",
    ),
    "EXECUTION_MISS_RATE_CS_BREACH": BreakerReasonSpec(
        reason_code="EXECUTION_MISS_RATE_CS_BREACH",
        breaker_type=BREAKER_TYPE_STATISTICAL_RISK,
        subtype="confidence_sequence_monitor",
        default_action=ACTION_HALT_NEW_INTENTS,
        clear_policy=CLEAR_POLICY_ONLINE_BASELINE_CLEAR,
        summary="The execution-miss-rate confidence-sequence monitor breached its threshold.",
    ),
    "RISK_CONTROL_EDGE_GAP_CS_BREACH": BreakerReasonSpec(
        reason_code="RISK_CONTROL_EDGE_GAP_CS_BREACH",
        breaker_type=BREAKER_TYPE_STATISTICAL_RISK,
        subtype="confidence_sequence_monitor",
        default_action=ACTION_HALT_NEW_INTENTS,
        clear_policy=CLEAR_POLICY_ONLINE_BASELINE_CLEAR,
        summary="The expected-vs-realized edge-gap confidence-sequence monitor breached its threshold.",
    ),
    "FEATURE_DIVERGENCE_CS_BREACH": BreakerReasonSpec(
        reason_code="FEATURE_DIVERGENCE_CS_BREACH",
        breaker_type=BREAKER_TYPE_STATISTICAL_RISK,
        subtype="feature_divergence_monitor",
        default_action=ACTION_HALT_NEW_INTENTS,
        clear_policy=CLEAR_POLICY_ONLINE_BASELINE_CLEAR,
        summary="The paper/live feature-divergence confidence-sequence monitor breached its threshold.",
    ),
