...
def _dashboard_ops_catalog(project_root: Path) -> dict[str, dict[str, Any]]:
    ...
    return {
        "restart_paper_champion": {
            ...
            "description": "Restart autobot-paper-v4.service.",
            "category": "services",
            "confirm": "Restart the champion paper service now?",
            "kind": "command",
        ...
        "restart_paper_challenger": {
            ...
            "description": "Restart autobot-paper-v4-challenger.service.",
            "category": "services",
            "confirm": "Restart the challenger paper service now?",
            "kind": "command",
        ...
        "restart_canary": {
            ...
            "description": "Restart autobot-live-alpha-candidate.service.",
            "category": "services",
            "confirm": "Restart the live canary service now?",
            "kind": "command",
        ...
        "clear_canary_breaker": {
            ...
            "category": "recovery",
            "confirm": "Clear the persistent canary live breaker now?",
            "kind": "clear_breaker",
        ...
        "try_restart_live_main": {
            ...
            "category": "services",
            "confirm": "Try-restart the main live service now?",
            "kind": "command",
        ...
        "clear_live_main_breaker": {
            ...
            "category": "recovery",
            "confirm": "Clear the persistent main live breaker now?",
            "kind": "clear_breaker",
        ...
        "restart_ws_public": {
            ...
            "description": "Restart autobot-ws-public.service.",
            "category": "services",
            "confirm": "Restart the public WS collector now?",
            "kind": "command",
        ...
        "start_spawn_only": {
            "id": "start_spawn_only",
            "label": "Spawn Only",
            "description": "Run the 00:10 challenger spawn cycle now.",
            "category": "pipeline",
            "confirm": "Run spawn_only now?",
            "kind": "command",
        ...
        "start_promote_only": {
            ...
            "label": "Promote Only",
            "description": "Run the 23:50 challenger promote cycle now.",
            "category": "pipeline",
            "confirm": "Run promote_only now?",
            "kind": "command",
        ...
        "start_rank_shadow": {
            ...
            "label": "Rank Shadow",
            "description": "Run the rank shadow cycle now.",
            "category": "pipeline",
            "confirm": "Run rank shadow now?",
            "kind": "command",
        ...
        "adopt_latest_candidate": {
            ...
            "description": (
                f"Adopt latest_candidate {latest_candidate_run_id} to challenger paper and canary."
                if latest_candidate_run_id
                else "Adopt latest_candidate to challenger paper and canary."
            ),
            "category": "binding",
            "confirm": "Adopt the current latest_candidate to challenger paper and canary now?",
