...
def build_parser() -> argparse.ArgumentParser:
    ...
    paper_run_parser.add_argument(
        ...
        choices=("offline_parquet", "live_v4"),
    ...
    paper_alpha_parser.add_argument(
        "--preset",
        choices=("live_v4", "candidate_v4", "offline", "offline_v4", "default"),
        default=DEFAULT_PAPER_ALPHA_PRESET,
        help="Shortcut preset. default=config-driven, live_v4 uses live providers, offline variants use parquet providers. Current default rollout is live_v4.",
    )
