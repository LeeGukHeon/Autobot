...
def build_parser() -> argparse.ArgumentParser:
    ...
    features_build_parser.add_argument("--label-set", default="v1", choices=("v1", "v2", "v3"))
    ...
    model_train_parser.add_argument("--label-set", default="v1", choices=("v1", "v2", "v3"))
    ...
    paper_run_parser.add_argument("--selection-policy-mode", choices=("auto", "raw_threshold", "rank_effective_quantile"), help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--use_learned_selection_recommendations", action="store_true", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--no-use_learned_selection_recommendations", dest="use_learned_selection_recommendations", action="store_false", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--use_learned_exit_mode", action="store_true", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--no-use_learned_exit_mode", dest="use_learned_exit_mode", action="store_false", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--use_learned_hold_bars", action="store_true", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--no-use_learned_hold_bars", dest="use_learned_hold_bars", action="store_false", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--use_learned_risk_recommendations", action="store_true", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--no-use_learned_risk_recommendations", dest="use_learned_risk_recommendations", action="store_false", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--use_trade_level_action_policy", action="store_true", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--no-use_trade_level_action_policy", dest="use_trade_level_action_policy", action="store_false", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--use_learned_execution_recommendations", action="store_true", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--no-use_learned_execution_recommendations", dest="use_learned_execution_recommendations", action="store_false", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--evaluation-contract-id", help=argparse.SUPPRESS)
    paper_run_parser.add_argument("--evaluation-contract-role", help=argparse.SUPPRESS)
    ...
    paper_alpha_parser.add_argument("--selection-policy-mode", choices=("auto", "raw_threshold", "rank_effective_quantile"), help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--use_learned_selection_recommendations", action="store_true", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--no-use_learned_selection_recommendations", dest="use_learned_selection_recommendations", action="store_false", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--use_learned_exit_mode", action="store_true", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--no-use_learned_exit_mode", dest="use_learned_exit_mode", action="store_false", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--use_learned_hold_bars", action="store_true", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--no-use_learned_hold_bars", dest="use_learned_hold_bars", action="store_false", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--use_learned_risk_recommendations", action="store_true", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--no-use_learned_risk_recommendations", dest="use_learned_risk_recommendations", action="store_false", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--use_trade_level_action_policy", action="store_true", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--no-use_trade_level_action_policy", dest="use_trade_level_action_policy", action="store_false", help=argparse.SUPPRESS)
    paper_alpha_parser.add_argument("--use_learned_execution_recommendations", action="store_true", help=argparse.SUPPRESS)
    ...
    backtest_alpha_parser.add_argument("--selection-policy-mode", choices=("auto", "raw_threshold", "rank_effective_quantile"), help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--use_learned_selection_recommendations", action="store_true", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--no-use_learned_selection_recommendations", dest="use_learned_selection_recommendations", action="store_false", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--use_learned_exit_mode", action="store_true", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--no-use_learned_exit_mode", dest="use_learned_exit_mode", action="store_false", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--use_learned_hold_bars", action="store_true", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--no-use_learned_hold_bars", dest="use_learned_hold_bars", action="store_false", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--use_learned_risk_recommendations", action="store_true", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--no-use_learned_risk_recommendations", dest="use_learned_risk_recommendations", action="store_false", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--use_trade_level_action_policy", action="store_true", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--no-use_trade_level_action_policy", dest="use_trade_level_action_policy", action="store_false", help=argparse.SUPPRESS)
    backtest_alpha_parser.add_argument("--use_learned_execution_recommendations", action="store_true", help=argparse.SUPPRESS)
    ...
    try:
        ...
        if args.model_command == "train":
            ...
            if trainer == "v5_sequence":
                ...
                summary_v5_sequence = train_and_register_v5_sequence(options_v5_sequence)
                print(
                    "[model][train][v5_sequence] "
                    f"run_id={summary_v5_sequence.run_id} status={summary_v5_sequence.status} "
                    f"test_precision_top5={summary_v5_sequence.leaderboard_row.get('test_precision_top5', 0.0):.6f} "
                    f"test_pr_auc={summary_v5_sequence.leaderboard_row.get('test_pr_auc', 0.0):.6f}"
                )
                print(f"[model][train][v5_sequence] run_dir={summary_v5_sequence.run_dir}")
                print(f"[model][train][v5_sequence] train_report={summary_v5_sequence.train_report_path}")
                print(f"[model][train][v5_sequence] walk_forward={summary_v5_sequence.walk_forward_report_path}")
                print(f"[model][train][v5_sequence] sequence_contract={summary_v5_sequence.sequence_model_contract_path}")
