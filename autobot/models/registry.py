...
def _normalize_artifact_status(run_id: str, payload: dict[str, Any] | None) -> dict[str, Any]:
    ...
    return {
        ...
        "tail_context_written": bool(doc.get("tail_context_written", False)),
        ...
        "promotion_complete": bool(doc.get("promotion_complete", False)),
        "decision_surface_complete": bool(doc.get("decision_surface_complete", False)),
        "expert_prediction_table_complete": bool(doc.get("expert_prediction_table_complete", False)),
