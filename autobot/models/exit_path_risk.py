...
def _summarize_sample_group(*, hold_bars: int, samples: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "profit_positive_q": _threshold_rate(terminal, 0.0, inclusive=False),
        "profit_floor_ratio": 0.0010,
        "profit_above_floor_q": _threshold_rate(terminal, 0.0010, inclusive=False),
        "continue_edge_q50": _quantile(terminal, 0.50),
        "continue_edge_q75": _quantile(terminal, 0.75),
        "mfe_q25": _quantile(mfe, 0.25),
        "mfe_q50": _quantile(mfe, 0.50),
        "mfe_q75": _quantile(mfe, 0.75),
        "mfe_q90": _quantile(mfe, 0.90),
        "mfe_above_10bps_rate": _threshold_rate(mfe, 0.0010, inclusive=False),
        "mfe_above_25bps_rate": _threshold_rate(mfe, 0.0025, inclusive=False),
        "mfe_above_50bps_rate": _threshold_rate(mfe, 0.0050, inclusive=False),
