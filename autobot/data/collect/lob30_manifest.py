"""Manifest helpers for lob30 parquet dataset."""
...
LOB30_MANIFEST_SCHEMA: dict[str, pl.DataType] = {
...
def empty_manifest() -> pl.DataFrame:
    return pl.DataFrame([], schema=LOB30_MANIFEST_SCHEMA, orient="row")
...
def normalize_manifest_rows(rows: list[dict[str, Any]]) -> pl.DataFrame:
    ...
    return pl.DataFrame(normalized, schema=LOB30_MANIFEST_SCHEMA, orient="row")
