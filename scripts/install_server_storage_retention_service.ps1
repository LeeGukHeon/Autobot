param(
    ...
    [int]$AcceptanceBacktestCacheRetentionDays = 14,
    ...
    [int]$EmergencyAcceptanceBacktestCacheRetentionDays = 7,
...
function Build-ExecStart {
    ...
    $argList = @(
        ...
        "--acceptance-backtest-cache-retention-days", ([string]([Math]::Max([int]$AcceptanceBacktestCacheRetentionDays, 1))),
        ...
        "--emergency-acceptance-backtest-cache-retention-days", ([string]([Math]::Max([int]$EmergencyAcceptanceBacktestCacheRetentionDays, 1))),
