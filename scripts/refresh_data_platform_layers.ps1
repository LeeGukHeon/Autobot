param(
    ...
    [int]$CandlesMaxRequests = 10,
    [string]$WsCandleBaseDataset = "ws_candle_v1",
    [string]$WsCandleMarketSourceDataset = "candles_second_v1",
    ...
    [string]$Lob30MarketSourceDataset = "candles_second_v1",
    [string]$Lob30PlanPath = "data/collect/_meta/lob30_plan.json",
    [int]$Lob30DurationSec = 180,
    [string[]]$TensorMarkets = @(),
    [int]$TensorMaxMarkets = 5,
    [int]$TensorMaxAnchorsPerMarket = 16,
