...
. (Join-Path $PSScriptRoot "candidate_acceptance_common.ps1")
. (Join-Path $PSScriptRoot "candidate_acceptance_evidence.ps1")
. (Join-Path $PSScriptRoot "candidate_acceptance_runtime.ps1")
. (Join-Path $PSScriptRoot "candidate_acceptance_windows.ps1")
...
. (Join-Path $PSScriptRoot "candidate_acceptance_reporting.ps1")
